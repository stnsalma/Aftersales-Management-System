<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SpecialRequestByCommonMonitor.ascx.cs" Inherits="WSMS.Module.SpecialRequestByCommonMonitor" %>
...
<asp:Repeater runat="server" ID="rptrServicePending">
    ...
    <ItemTemplate>
        ...
        <div  style="width: 210px;  float: left;height:445px; border:1px solid #CCCCCC ;display:block;margin-top:-415px;background-color: #F2E0F7;">
          ...
          <div style="width: 210px; height: 30px; line-height: 30px;  border-left: 1px solid #CCCCCC;
             ...
             <div id="cellphone" class="left-bottom">
                    ...
                    <input type="text" id="input-cellnumber" style="width: 200px;border-top: 1px solid #CCCCCC;border-bottom: 1px solid #CCCCCC; height: 25px; line-height: 23px;word-break: break-word;
             ...
             <div id="details" class="left-bottom"  style="border-top: 1px solid #CCCCCC;border-bottom: 1px solid #CCCCCC;color: #000000;background-color: #F2E0F7;">
              ...
              <div id="seen_or_not" class="left-bottom" style="border-top: 1px solid #CCCCCC;border-bottom: 1px solid #CCCCCC;color: #000000;background-color: #F2E0F7;">
               ...
               <div id="rep_imei_1" class="left-bottom"  style="border-top: 1px solid #CCCCCC;border-bottom: 1px solid #CCCCCC;display:block;color: #000000;background-color: #F2E0F7;">
                 
                    <input type="text" id="insert_rep_imei_1" style="width: 200px; height: 25px; line-height: 23px;word-break: break-word;
                        margin-left: 1px; margin-top: 2px; background-color: Silver;color: #000000;" />
           
              </div>
              <div id="rep_imei_2" class="left-bottom"  style="border-top: 1px solid #CCCCCC;border-bottom: 1px solid #CCCCCC;display:block;color: #000000;background-color: #F2E0F7;">
                 
                    <input type="text" id="insert_rep_imei_2" style="width: 200px; height: 25px; line-height: 23px;word-break: break-word;
                        margin-left: 1px; margin-top: 2px; background-color: Silver;color: #000000;" />
           
             </div>

              <div id="rep_model" class="left-bottom" style="border-top: 1px solid #CCCCCC;border-bottom: 1px solid #CCCCCC;display:block;color: #000000;background-color: #F2E0F7;">
            ...
            <div style="width:210px; height: 30px; line-height: 30px;  border-left: 1px solid #CCCCCC;
               ...
               <div id="btn-request-IMRI-1" style="border:1px solid #83AF45;width:80px;height:20px;line-height:20px;text-align:center;
