<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WastageHandsetMovement.ascx.cs" Inherits="WSMS.Module.WastageHandsetMovement" %>
...
<asp:Repeater runat="server" ID="rptrServicePending">
    ...
    <ItemTemplate>
        ...
        <div  style="width:1239px;  float: left; border:1px solid #CCCCCC ;display:block;font-size:11px">
         ...
         <div style="width: 70px; line-height: 30px; float: left; border-left: 0px solid #CCCCCC;height:70px;
            ...
            <div id="requestdate1"  style="width:65px; line-height: 30px; float: left; border-left: 1px solid #CCCCCC;height:70px;
                border-bottom: 1px solid #CCCCCC; text-align: center;color: #000000;background-color: #F2E0F7;border-right: 1px solid #FFFFFF;">
                &nbsp;
             ...
             <div style="width:65px; line-height: 30px; float: left; border-left: 1px solid #CCCCCC;height:70px;
                border-bottom: 1px solid #CCCCCC; text-align: center;color: #000000;background-color: #F2E0F7;border-right: 1px solid #FFFFFF;">
                &nbsp;
                <%# DataBinder.Eval(Container.DataItem, "WastageReceivedDate", "{0:yyyy-MM-dd}")%>
           ...
           <div style="width: 110px; line-height: 30px; float: left; border-left: 1px solid #CCCCCC;height:70px;
            ...
            <div style="width:180px;line-height: 30px;height:30px; float: left; border-left: 1px solid #CCCCCC;height:70px;
               ...
               <div id="btn-warehouse" style="border:1px solid #83AF45;width:120px;height:20px;line-height:20px;text-align:center;
                    font-weight:bold;font-style:italic;cursor:pointer;float:left;margin-left:30px;margin-top:4px;">
                  
                    Send to Warehouse
                </div>
               <div id="btn-corporateStore" style="border:1px solid #83AF45;width:150px;height:20px;line-height:20px;text-align:center;
                    font-weight:bold;font-style:italic;cursor:pointer;float:left;margin-left:15px;margin-top:15px;">
                  
                    Send to CorporateStore
                </div>
            </div>
