<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WastageReport.ascx.cs" Inherits="WSMS.Module.WastageReport" %>
...
<asp:Repeater runat="server" ID="rptrServicePending">
    ...
    <ItemTemplate>
        ...
        <div  style="width:1144px;  float: left; border:1px solid #CCCCCC ;display:block;font-size:11px">
