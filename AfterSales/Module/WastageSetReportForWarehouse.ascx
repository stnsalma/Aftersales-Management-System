<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WastageSetReportForWarehouse.ascx.cs" Inherits="WSMS.Module.WastageSetReportForWarehouse" %>
<asp:Repeater runat="server" ID="rptrServicePending">
    <HeaderTemplate>
       ...
       <div style="width: 2220px;margin-top:20px;font-size:11px"> 
        ...
        <div class="grid" style="width: 70px;height:60px; color:#000000;background-color: #E6E6E6;border-right: 1px solid #FFFFFF;">
         ...
         <div class="grid" style="width: 75px;height:60px; color:#000000;background-color: #E6E6E6;border-right: 1px solid #FFFFFF;">
             Wastage ReceiveDate
        </div>
         <div class="grid" style="width: 75px;height:60px; color:#000000;background-color: #E6E6E6;border-right: 1px solid #FFFFFF;">
             Wastage DeliveryDate
        </div>
         <div class="grid" style="width: 75px;height:60px; color:#000000;background-color: #E6E6E6;border-right: 1px solid #FFFFFF;">
             Warehouse ReceiveDate
        </div>       
    ...
    <ItemTemplate>
        ...
        <div  style="width:1241px;  float: left; border:1px solid #CCCCCC ;display:block;font-size:11px">
         ...
         <div style="width: 70px; line-height: 30px; float: left; border-left: 0px solid #CCCCCC;height:70px;
            ...
            <div style="width:65px; line-height: 30px; float: left; border-left: 1px solid #CCCCCC;height:70px;
             ...
             <div style="width:75px; line-height: 30px; float: left; border-left: 1px solid #CCCCCC;height:70px;
                border-bottom: 1px solid #CCCCCC; text-align: center;color: #000000;background-color: #F2E0F7;border-right: 1px solid #FFFFFF;">
                &nbsp;
             ...
             <div style="width:75px; line-height: 30px; float: left; border-left: 1px solid #CCCCCC;height:70px;
                border-bottom: 1px solid #CCCCCC; text-align: center;color: #000000;background-color: #F2E0F7;border-right: 1px solid #FFFFFF;">
                &nbsp;
                <%# DataBinder.Eval(Container.DataItem, "MovementDateToWarehouse", "{0:yyyy-MM-dd}")%>
                     
            </div>
             <div style="width:75px; line-height: 30px; float: left; border-left: 1px solid #CCCCCC;height:70px;
                border-bottom: 1px solid #CCCCCC; text-align: center;color: #000000;background-color: #F2E0F7;border-right: 1px solid #FFFFFF;">
                &nbsp;
                <%# DataBinder.Eval(Container.DataItem, "WarehouseReceiveDate", "{0:yyyy-MM-dd}")%>
