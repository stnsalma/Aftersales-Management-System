<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReceiveMemo.aspx.cs" Inherits="WSMS.ReceiveMemo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div id="header" style="width:100%;float:left">
            ...
            <div id="Caption" style="width:500px;float:left;min-height:100px;border:0px solid red">
                ...
                <div style="width:100%;float:left;height:30px;position: relative; border:0px solid red">
                    <span style="position: absolute; bottom: 0;font-size:20px;font-weight:bold;font-style:italic;color:Maroon">Service Receive Memo</span> 
                </div>
            </div>
            ...
            <ItemTemplate>
                <div id="reportBody" style="width: 100%; float: left">
                    ...
                    <div style="width: 800px; float: left">
                        ...
                        <div style="width: 600px; float: left; height:25px;line-height:25px">
                            <%# DataBinder.Eval(Container.DataItem, "ReceivedItem")%>
                        </div>
                    ...
                    <div style="width: 800px; float: left">
                        ...
                        <div style="width: 600px; float: left; height:25px;line-height:25px">
                            <%# DataBinder.Eval(Container.DataItem, "ExpectedDeliveryDate")%>
                        </div>
                    ...
                    <div style="width: 800px; float: left">
                        ...
                        <fieldset>
                            <legend> Service Billing Information :</legend>
                            <div style="width: 800px; float: left; ">
    ...
    <div style="clear:both"></div>
    <div style="width:842;border:0px solid red ; height:25px;line-height:25px;margin-left:300px">
