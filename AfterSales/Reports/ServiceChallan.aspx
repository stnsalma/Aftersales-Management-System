<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ServiceChallan.aspx.cs" Inherits="WSMS.ServiceChallan" %>
        ...
        <div id="header" style="width:100%;float:left">
            ...
            <div id="Caption" style="width:500px;float:left;min-height:100px;border:0px solid red">
                ...
                <div style="width:100%;float:left;height:30px;position: relative; border:0px solid red">
                    <span style="position: absolute; bottom: 0;font-size:20px;font-weight:bold;font-style:italic;color:Maroon">Service Challan</span> 
                </div>
            </div>
